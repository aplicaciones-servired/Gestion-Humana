  ...
  return (
    <div className="h-full font-sans">
      ...
      <a 
        ...
        className="absolute bottom-4 right-4 md:left-4 md:bottom-10 max-w-[300px] md:max-w-full p-4 bg-white rounded-2xl border border-white no-underline transition-colors duration-200 backdrop-blur-[50px] hover:bg-white/55 max-h-[368px]:hidden"
      >
        ...
        <h2 className="mt-0 mb-4 font-normal text-gray-900 text-xl">What's New in Astro 5.0?</h2>
        <p className="text-gray-600 text-base leading-6 tracking-tight m-0">
